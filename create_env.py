...
def create_train_env(data_source,
                     train_start_date,
                     train_end_date,
                     time_interval,
                     ticker_list,
    ...
    dp = DataProcessor(data_source, train_start_date, train_end_date, time_interval, **kwargs)
...
def create_test_env(data_source,
                     test_start_date,
                     test_end_date,
                     time_interval,
                     ticker_list,
    ...
    dp = DataProcessor(data_source, test_start_date, test_end_date, time_interval, **kwargs)
